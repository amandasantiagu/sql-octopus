(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_shepherd_js_dist_esm_shepherd_mjs_7f4a05._.js", {

"[project]/node_modules/shepherd.js/dist/esm/shepherd.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ function getUtils(options, customizedDeepmerge) {
    ...
    return {
        ...
        mergeFunctions: _extends({}, mergeFunctions, Object.fromEntries(Object.entries(options).filter(([key, option])=>Object.hasOwn(mergeFunctions, key)).map(([key, option])=>option === false ? [
                key,
 ...
 */ const autoPlacement$1 = function autoPlacement(options) {
    ...
    return {
        ...
        async fn (state) {
            ...
            const _evaluate = evaluate(options, state), { crossAxis = false, alignment, allowedPlacements = placements, autoAlignment = true } = _evaluate, detectOverflowOptions = _objectWithoutPropertiesLoose(_evaluate, _excluded);
 ...
 */ const flip$1 = function flip(options) {
    ...
    return {
        ...
        async fn (state) {
            ...
            const _evaluate2 = evaluate(options, state), { mainAxis: checkMainAxis = true, crossAxis: checkCrossAxis = true, fallbackPlacements: specifiedFallbackPlacements, fallbackStrategy = 'bestFit', fallbackAxisSideDirection = 'none', flipAlignment = true } = _evaluate2, detectOverflowOptions = _objectWithoutPropertiesLoose(_evaluate2, _excluded2);
 ...
 */ const shift$1 = function shift(options) {
    ...
    return {
        ...
        async fn (state) {
            ...
            const _evaluate4 = evaluate(options, state), { mainAxis: checkMainAxis = true, crossAxis: checkCrossAxis = false, limiter = {
                fn: (_ref)=>{
                    let { x, y } = _ref;
                    return {
                        x,
 ...
 */ function getFloatingUIOptions(attachToOptions, step) {
    ...
    if (!shouldCenter) {
        ...
        options.middleware.push(// Replicate PopperJS default behavior.
        shift({
            limiter: limitShift(),
            crossAxis: true
        }));
 ...
 */ const always_set_through_set_attribute = [
    'width',
    'height'
];
/**
...
/** @typedef {1} INTRO */ /** @typedef {0} OUTRO */ /** @typedef {{ direction: 'in' | 'out' | 'both' }} TransitionOptions */ /** @typedef {(node: Element, params: any, options: TransitionOptions) => import('../transition/public.js').TransitionConfig} TransitionFn */ /**
...
/* src/components/shepherd-button.svelte generated by Svelte v4.2.19 */ function create_fragment$8(ctx) {
    let button;
...
/* src/components/shepherd-footer.svelte generated by Svelte v4.2.19 */ function get_each_context(ctx, list, i) {
...
/* src/components/shepherd-cancel-icon.svelte generated by Svelte v4.2.19 */ function create_fragment$6(ctx) {
    let button;
    let span;
    let button_aria_label_value;
    let mounted;
...
/* src/components/shepherd-title.svelte generated by Svelte v4.2.19 */ function create_fragment$5(ctx) {
    let h3;
    return {
        c () {
            h3 = element("h3");
...
/* src/components/shepherd-header.svelte generated by Svelte v4.2.19 */ function create_if_block_1$1(ctx) {
    let shepherdtitle;
    let current;
...
/* src/components/shepherd-text.svelte generated by Svelte v4.2.19 */ function create_fragment$3(ctx) {
    let div;
    return {
        c () {
            div = element("div");
...
/* src/components/shepherd-content.svelte generated by Svelte v4.2.19 */ function create_if_block_2(ctx) {
    let shepherdheader;
    let current;
...
/* src/components/shepherd-element.svelte generated by Svelte v4.2.19 */ function create_if_block(ctx) {
    let div;
    return {
        c () {
            div = element("div");
    ...
    return {
        ...
        p (ctx, [dirty]) {
            ...
            set_attributes(dialog, dialog_data = get_spread_update(dialog_levels, [
                (!current || dirty & /*step, descriptionId*/ 20 && dialog_aria_describedby_value !== (dialog_aria_describedby_value = !isUndefined(/*step*/ ctx[4].options.text) ? /*descriptionId*/ ctx[2] : null)) && {
...
/* src/components/shepherd-modal.svelte generated by Svelte v4.2.19 */ function create_fragment(ctx) {
    let svg;
    let path;
    let svg_class_value;
    let mounted;
...
function instance($$self, $$props, $$invalidate) {
  ...
  */ function _styleForStep(step) {
        const { modalOverlayOpeningPadding, modalOverlayOpeningRadius, modalOverlayOpeningXOffset = 0, modalOverlayOpeningYOffset = 0 } = step.options;
...
//# sourceMappingURL=node_modules_shepherd_js_dist_esm_shepherd_mjs_7f4a05._.js.map